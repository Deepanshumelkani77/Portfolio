...
const About = () => {
  ...
  const stats=[{label:"Experience", value:"Fresher"},
...
<div className="flex-1 flex flex-col justify-center text-center md:text-left">
  <h2 className="text-4xl sm:text-5xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r   from-[#1cd8d2] via-[#00bf8f] to-[#1cd8d2] ">Deepanshu Melkani</h2>
<p className="mt-2 text-lg sm:text-xl text-white/90 font-semibold ">Full Stack Developer</p>
<p className="mt-4 text-gray-300 leading-relex text-base sm:text-lg max-w-2xl md_max-w-3xl">I build scalable and modern web applications with a strong focus on clean architecture, intuitive user experience, and high performance. My expertise spans the MERN stack—MongoDB, Express.js, React.js, and Node.js—allowing me to transform ideas into production-ready solutions with robust APIs and seamless interfaces. From front-end design to back-end engineering, I deliver reliable, efficient, and user-focused full-stack applications.</p>
...
transition={{duratine:0.6}}
viewport={{once:true,amount:0.4}}
>
  <h3 className="text-2xl sm:text-3xl font-bold text-white mb-3">About Me</h3>
  <p className="text-gray-300 leading-relaxed text-base sm:text-lg">I'm a Software Developer and Web Developer - passinate about building fast , resilient applications and sharing coading insights on instagram and YouTube.</p>
